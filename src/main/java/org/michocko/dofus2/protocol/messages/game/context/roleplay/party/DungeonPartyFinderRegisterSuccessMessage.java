...
@ToString 
@EqualsAndHashCode
public class DungeonPartyFinderRegisterSuccessMessage implements INetworkMessage {
	...
	public DungeonPartyFinderRegisterSuccessMessage(Collection<Short> dungeonIds) {
